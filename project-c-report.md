# Project C: Purple Team Detection Validation — AD Credential Access Chain
...
| LLMNR Poisoning (manual) | — | Broadcast segment | Prior (elk-siem-lab) |

## 4. Detection Results

Full interactive heatmap: `project-c-heatmap-layer.json` (load into [ATT&CK Navigator](https://mitre-attack.github.io/attack-navigator/) via "Open Existing Layer").
...
| T1557.001 – LLMNR Poisoning | — | No rule exists | 0 | 🔴 Gap |
...
---
*Companion file: `project-c-heatmap-layer.json` (ATT&CK Navigator layer)*
